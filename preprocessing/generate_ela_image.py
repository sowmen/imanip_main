...
def ELA(param, DIR_ROOT):
    ...
    if os.path.exists(os.path.join(ROOT,ela_path)):
        return
...
def main():
    ...
    df = pd.read_csv('/media/crimson/Dataset/image_manipulation/preprocessing/nist_extendv2.csv')
    DIR_ROOT = "/media/crimson/SSD Disk/Datasets"
