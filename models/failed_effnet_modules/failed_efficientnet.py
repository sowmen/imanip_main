...
from models.failed_effnet_modules.utils import *
        ...
        for block_args in self.block_args_list:
            ...
            block_args = block_args._replace(
                ...
                num_repeat=round_repeats(
                    block_args.num_repeat, self.global_params)
            )

            # The first block needs to take care of stride and filter size increase.
            self._blocks.append(MBConvBlock(
                block_args, self.global_params, idx=idx))
            idx += 1
            ...
            class CustomHead(nn.Module):
                def __init__(self, out_channels):
                    ...
                    self.custom_head = custom_head(
                        self.n_channels * 2, out_channels)
