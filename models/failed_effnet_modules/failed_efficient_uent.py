...
from models.failed_effnet_modules.failed_efficientnet import EfficientNet
...
def get_efficientunet_b0(out_channels=2, concat_input=True, pretrained='imagenet'):
    encoder = EfficientNet.encoder('efficientnet-b0', pretrained=pretrained)
    model = EfficientUnet(
        encoder, out_channels=out_channels, concat_input=concat_input)
    return model


def get_efficientunet_b1(out_channels=2, concat_input=True, pretrained='imagenet'):
...
def get_efficientunet_b2(out_channels=2, concat_input=True, pretrained='imagenet'):
...
def get_efficientunet_b3(out_channels=2, concat_input=True, pretrained='imagenet'):
...
def get_efficientunet_b4(out_channels=2, concat_input=True, pretrained='imagenet'):
...
def get_efficientunet_b5(out_channels=2, concat_input=True, pretrained='imagenet'):
...
def get_efficientunet_b6(out_channels=2, concat_input=True, pretrained='imagenet'):
...
def get_efficientunet_b7(out_channels=2, concat_input=True, pretrained='imagenet'):
